            ...
            for(Integer[] p1 : points){
                for(Integer[] p2 : points){
                    if(p1==p2)
                        ...
                        Integer[] new1 = new Integer[]{p1[0],p1[1]};
                        Integer[] new2 = new Integer[]{p2[0],p2[1]};

                        while(new1[0]<rows && new1[0]>=0 && new1[1]<cols && new1[1]>=0){
                        ...
                        while(new2[0]<rows && new2[0]>=0 && new2[1]<cols && new2[1]>=0){
